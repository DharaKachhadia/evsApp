...
import { View, Text,StyleSheet,TouchableOpacity,Image,TextInput,StatusBar,BackHandler,Linking,Modal,Animated,Alert} from 'react-native'
...
const Service = (props ,navigation) => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Text style={{marginVertical: 20, fontSize: 20, textAlign: 'center',fontWeight:'bold',coloe:'black'}}>
        Your Message Send successfully !
      </Text>
      <TouchableOpacity onPress={() => props.navigation.replace("Drawer")} activeOpacity={0.7} style={{ alignSelf: 'center',height:40, width:'40%',backgroundColor:'#75c31e',borderRadius:5,marginTop:20}}>
