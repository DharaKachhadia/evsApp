...
const Map = props => {
  ...
  const navigationView = () => (
    <View style={[styles.container1, styles.navigationContainer]}>
      ...
      <ImageBackground
        source={require('../images/backk.jpg')}
        style={{width: '100%'}}>
        <View style={{flexDirection: 'row'}}>
          ...
          <TouchableOpacity onPress={() => drawer.current.closeDrawer()}>
            <Ionicons
              name="chevron-back"
              size={40}
              style={{marginLeft: 50, marginTop: 20, color: '#acd1af'}}
            />
          </TouchableOpacity>
        </View>
        <Text
      ...
      <TouchableOpacity
        ...
        <View style={styles.drawer}>
          <Image
            source={require('../images/charging.png')}
            style={{height: 45, width: 45, marginTop: 5}}
          />
          <Text
            style={{
        ...
        <TouchableOpacity
          ...
          <View
            ...
            <Image
              ...
              style={{height: 25, width: 25, marginTop: 14, marginLeft: 15}}
            />
            <Text
              style={{
                fontSize: 15,
  ...
  /> */}
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => props.navigation.replace('StationList')}>
            <Image
              source={require('../assets/chargebook.png')}
              style={{height: 30, width: 30, marginTop: 5, alignSelf: 'center'}}
            />
          </TouchableOpacity>
        </View>
        ...
        <View
          ...
          <TouchableOpacity onPress={() => props.navigation.replace('history')}>
            <Ionicons
              name="calendar"
              size={32}
              style={{color: 'green', alignSelf: 'center', marginTop: 5}}
            />
          </TouchableOpacity>
        </View>
            ...
            <View style={styles.card} key={index}>
              ...
              <View style={styles.textContent}>
                ...
                <View style={styles.button}>
                  <TouchableOpacity
                    onPress={() => props.navigation.replace('StationDetails',{item:marker})}
                    style={[
                      styles.signIn,
                      {
                        borderColor: 'white',
