        ...
        <ActivityIndicator size="large" color="#75C31E" />
            ...
            renderItem={({item}) => (
              <View style={styles.history}>
                ...
                <View
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      props.navigation.replace('Historydetails', {item});
                    }}>
                    <Text
                      style={{
                        alignSelf: 'center',
          ...
          />
            ...
            <View style={{flex: 1,justifyContent: 'center', alignItems: 'center'}}>
              <Image source={require('../images/NoHistory.jpg')} style={{height:300,width:'80%'}} resizeMode="contain"/>
            <Text style={{color:'#ccc',fontSize:28}}>No History Are Found</Text>
            </View>
